...
urlpatterns = [
    ...
    path('admin-take-course/<str:cl>', views.admin_take_course_view,name='admin-take-course'),
    path('admin-view-course/<str:cl>', views.admin_view_course_view,name='admin-view-course'),
    path('course-dashboard', views.course_dashboard_view,name='course-dashboard'),
